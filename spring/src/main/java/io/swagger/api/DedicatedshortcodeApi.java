...
public interface DedicatedshortcodeApi {
    ...
    @RequestMapping(value = "/dedicatedshortcode/viewshortcode.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> dedicatedshortcodeViewshortcode(@ApiParam(value = "List of valid Dedicated Short Code to your Ytel account", required=true) @RequestPart(value="Shortcode", required=true)  String shortcode);
