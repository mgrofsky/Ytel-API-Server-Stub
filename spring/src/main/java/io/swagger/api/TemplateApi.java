...
public interface TemplateApi {
    ...
    @RequestMapping(value = "/template/view.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> templateView(@ApiParam(value = "The unique identifier for a template object", required=true) @RequestPart(value="TemplateId", required=true)  UUID templateId);
