...
public interface AddressApi {
    ...
    @RequestMapping(value = "/address/deleteaddress.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> addressDeleteaddress(@ApiParam(value = "The identifier of the address to be deleted.", required=true) @RequestPart(value="addressid", required=true)  String addressid);
    ...
    @RequestMapping(value = "/address/verifyaddress.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> addressVerifyaddress(@ApiParam(value = "The identifier of the address to be verified.", required=true) @RequestPart(value="addressid", required=true)  String addressid);
    ...
    @RequestMapping(value = "/address/viewaddress.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> addressViewaddress(@ApiParam(value = "The identifier of the address to be retrieved.", required=true) @RequestPart(value="addressid", required=true)  String addressid);
