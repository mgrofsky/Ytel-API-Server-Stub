...
public interface AccountsApi {
    ...
    ResponseEntity<String> accountsViewaccount(@ApiParam(value = "Filter account information based on date.", required=true) @RequestPart(value="Date", required=true)  String date);
