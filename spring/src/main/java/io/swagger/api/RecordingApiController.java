...
public class RecordingApiController implements RecordingApi {
    ...
    private static final Logger log = LoggerFactory.getLogger(RecordingApiController.class);
    ...
    public RecordingApiController(ObjectMapper objectMapper, HttpServletRequest request) {
