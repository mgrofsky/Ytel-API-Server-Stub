...
public interface LetterApi {
    ...
    @RequestMapping(value = "/letter/delete.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> letterDelete(@ApiParam(value = "The unique identifier for a letter object.", required=true) @RequestPart(value="lettersid", required=true)  String lettersid);
    ...
    @RequestMapping(value = "/letter/viewletter.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> letterViewletter(@ApiParam(value = "The unique identifier for a letter object.", required=true) @RequestPart(value="lettersid", required=true)  String lettersid);
