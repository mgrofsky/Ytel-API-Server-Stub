...
public interface ConferencesApi {
    ...
    @RequestMapping(value = "/conferences/viewconference.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> conferencesViewconference(@ApiParam(value = "The unique identifier of each conference resource", required=true) @RequestParam(value="ConferenceSid", required=true)  String conferenceSid);
