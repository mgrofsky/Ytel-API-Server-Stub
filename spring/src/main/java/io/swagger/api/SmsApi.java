...
public interface SmsApi {
    ...
    @RequestMapping(value = "/sms/viewdetailsms.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> smsViewdetailsms(@ApiParam(value = "The unique identifier for a sms message.", required=true) @RequestPart(value="MessageSid", required=true)  String messageSid);
    ...
    @RequestMapping(value = "/sms/viewsms.json",
        ...
        consumes = { "application/x-www-form-urlencoded" },
        method = RequestMethod.POST)
    ResponseEntity<String> smsViewsms(@ApiParam(value = "The unique identifier for a sms message.", required=true) @RequestPart(value="MessageSid", required=true)  String messageSid);
